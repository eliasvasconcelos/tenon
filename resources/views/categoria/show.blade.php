...
@section('content')
    ...
    <main class="conteudo">
        ...
        <div class="thumb">
            ...
            <a href="#">Categoria</a> <i class="fa fa-angle-right fa-1x"></i> <b>{{$data->nome}}
            <span class="right" style="margin:5px 10px "><i class="fa fa-sort-amount-desc fa-1x"></i> Mostrando
                {{\App\Models\Anuncio::where('categoria_id', $data->id)->count()}} Anuncios</span>
        </div>
        <section id="destaque">
            <div class="top_esq">
            ...
            <section class="content">
                <div class="premium">
                    <h2 class="cabeca"><i class="fa fa-arrow-right fa-1x"></i> Anuncie Aqui</h2>
                        @forelse($data->anuncios->where('premium',1)->random(0) as $z)
